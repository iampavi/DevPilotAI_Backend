...
public interface IAiChatService
{
    ...
    Task<ChatMessageDto> SendMessageAsync(Guid sessionId, string userQuestion, string promptMode, ChatSettingsOverrideDto? settingsOverride = null, CancellationToken cancellationToken = default);
